...
#import re
# ---CSV file import---
df = pd.read_csv("/Users/jamie/Desktop/UNC Work Files/GUConferencePrint-150-5-3-16.csv")
...
md.columns = ['MD', 'MD2', 'MD3', 'MD4', 'MD5']

#print (md)

refmd = df.iloc[:, 2].str.split(',', expand=True)
refmd.columns = ['refmd-last','refmd-first']
...
df_out.to_csv("/Users/jamie/Desktop/UNC Work Files/GUConferencePrint-150-5-3-16export.csv", encoding='utf-8')
